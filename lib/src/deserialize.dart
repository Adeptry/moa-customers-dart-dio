  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'AppConfigUpdateDto':
          return AppConfigUpdateDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AppInstallUpdateDto':
          return AppInstallUpdateDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AuthAppleLoginDto':
          return AuthAppleLoginDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AuthEmailLoginDto':
          return AuthEmailLoginDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AuthForgotPasswordDto':
          return AuthForgotPasswordDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AuthGoogleLoginDto':
          return AuthGoogleLoginDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AuthRegisterLoginDto':
          return AuthRegisterLoginDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AuthResetPasswordDto':
          return AuthResetPasswordDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'AuthUpdateDto':
          return AuthUpdateDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'BusinessHoursPeriod':
          return BusinessHoursPeriod.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CatalogImage':
        ...
        case 'CategoryPaginatedResponse':
          return CategoryPaginatedResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CategoryUpdateAllDto':
          return CategoryUpdateAllDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CategoryUpdateDto':
          return CategoryUpdateDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CreateCardDto':
          return CreateCardDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Customer':
          return Customer.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'CustomersPaginatedResponse':
          return CustomersPaginatedResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'FileEntity':
        ...
        case 'ItemModifierList':
          return ItemModifierList.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ItemPaginatedResponse':
          return ItemPaginatedResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ItemUpdateAllDto':
          return ItemUpdateAllDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ItemUpdateDto':
          return ItemUpdateDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LineItem':
          return LineItem.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LineItemModifier':
          return LineItemModifier.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'Location':
          return Location.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LocationPaginatedResponse':
          return LocationPaginatedResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LocationUpdateAllDto':
          return LocationUpdateAllDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LocationUpdateDto':
          return LocationUpdateDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'LoginResponseType':
          return LoginResponseType.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'OrderCreateDto':
          return OrderCreateDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderPatchDto':
          return OrderPatchDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrderPostDto':
          return OrderPostDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'OrdersPaginatedReponse':
          return OrdersPaginatedReponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'PaymentCreateDto':
          return PaymentCreateDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'SquareCard':
          return SquareCard.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'SquareDisableCardResponse':
          return SquareDisableCardResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'SquareError':
          return SquareError.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'SquareListCardsResponse':
          return SquareListCardsResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'ThemeModeEnum':
        ...
        case 'VariationAddDto':
          return VariationAddDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'VariationUpdateDto':
          return VariationUpdateDto.fromJson(value as Map<String, dynamic>) as ReturnType;
        default:
          RegExpMatch? match;
