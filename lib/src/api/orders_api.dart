...
class OrdersApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrdersPaginatedReponse>> getManyOrders({
    num? page,
    num? limit,
    bool? closed,
    bool? lineItems,
  ...
  /// Returns a [Future] containing a [Response] with a [Order] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> getOneOrder({
    required String id,
    bool? lineItems,
    bool? location,
    String? actingAs,
  ...
  /// Returns a [Future] containing a [Response] with a [Order] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> patchCurrentOrder({
  ...
  /// Returns a [Future] containing a [Response] with a [Order] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> postCurrentOrder({
    required String merchantIdOrPath,
  ...
  /// Returns a [Future] containing a [Response] with a [Order] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> postCurrentOrderPaymentSquare({
    required String merchantIdOrPath,
